  ...
  return (
    <div className="flex gap-2 w-full items-center">
          ...
          <PopoverTrigger asChild>
            ...
            >
              {value && selectedPartner ? (
                ...
                <span className="text-muted-foreground truncate">{placeholder || "Selecionar parceiro..."}</span>
              )}
      ...
      <button 
        ...
        className="flex items-center justify-center shrink-0 h-9 w-9 rounded-md border bg-muted/30 hover:bg-muted transition-all active:scale-95 shadow-sm"
